...
@interface ESP8266ControlObject : KrollCoverageObject {
#else
@interface ESP8266ControlObject : KrollObject {
#endif
@private
...
extern NSString * ESP8266Control$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ESP8266ControlObject *_esp8266control;
    KrollObject* console;
	BOOL shutdown;
