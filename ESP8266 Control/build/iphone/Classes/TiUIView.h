...
/**
 Base class for all ESP8266Control views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ESP8266Control view hierarchy (such as wrapped iOS UIViews) was touched.
