...
// in simulator we redefine to format for ESP8266Control Developer console
...
{\
	NSString * exceptionName = [@"org.esp8266control." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.esp8266control";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIESP8266ControlNativeItemNone = -1, 
	UIESP8266ControlNativeItemSpinner = -2,
	UIESP8266ControlNativeItemProgressBar = -3,
	
	UIESP8266ControlNativeItemSlider = -4,
	UIESP8266ControlNativeItemSwitch = -5,
	UIESP8266ControlNativeItemMultiButton = -6,
	UIESP8266ControlNativeItemSegmented = -7,
	
	UIESP8266ControlNativeItemTextView = -8,
	UIESP8266ControlNativeItemTextField = -9,
	UIESP8266ControlNativeItemSearchBar = -10,
	
	UIESP8266ControlNativeItemPicker = -11,
	UIESP8266ControlNativeItemDatePicker = -12,
	
	UIESP8266ControlNativeItemInfoLight = -13,
	UIESP8266ControlNativeItemInfoDark = -14,
	
	UIESP8266ControlNativeItemDisclosure = -15,
	
	UIESP8266ControlNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ESP8266Control instances of
