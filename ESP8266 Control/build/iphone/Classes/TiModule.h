...
/**
 The base class for all ESP8266Control modules
 */
...
/**
 ESP8266Control Platform calls this method on startup.
 */
-(void)startup;

/**
 ESP8266Control Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 ESP8266Control Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 ESP8266Control Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 ESP8266Control Platform calls this method on resume.
 @param sender The sender of the event.
 */
