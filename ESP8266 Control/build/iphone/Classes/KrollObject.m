...
//@interface ESP8266ControlObject : NSObject
//@end

@interface ESP8266ControlObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ESP8266ControlObject class]])
		{
			for (NSString *key in [[(ESP8266ControlObject*)o modules] allKeys])
			{
