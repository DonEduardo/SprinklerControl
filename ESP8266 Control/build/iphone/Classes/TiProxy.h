...
//Rare exceptions to indicate a bug in the _esp8266control code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ESP8266Control proxies.
 */
